...
def get_store_product_model(store_id, category_model):
    ...
    attrs = {
        ...
        "category": models.ForeignKey(
            category_model, on_delete=models.CASCADE, related_name="products"
        ),
        "name": models.CharField(max_length=200),
        ...
        "min_discounted_price": models.DecimalField(
            max_digits=10, decimal_places=2, null=True, blank=True
        ),
...
def get_store_image_model(store_id, product_model):
    ...
    def save_image(self, *args, **kwargs):
        ...
        while (
            ImageModel.objects.filter(image_code=self.image_code)
            .exclude(pk=self.pk)
            .exists()
        ):
    ...
    attrs = {
        ...
        "product": models.ForeignKey(
            product_model, on_delete=models.CASCADE, related_name="images"
        ),
        "name": models.CharField(max_length=200),
        "image_code": models.CharField(
            max_length=200
        ),  # Not unique globally, but unique per store
